    ...
    public void menu() throws InputException, IOException, HeadlessException, EmptyFilenameException {
        do {
            ...
            try {
                ...
                if (n < 1 || n > 9) {
                    throw new InputException("Die Zahl muss zwischen 1 & 7 liegen !");
                }
                ...
                switch (n) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        medienListeSchreiben();
                        break;
                    case 5:
                        zeigeNeuesMedium();
                        break;
                    case 6:
                        durchSchnittErscheinungsjahr();
                        break;
                    case 7:
                        speichern();
                        break;
            ...
            do {
                try {
                    ...
                    if (interpret.isEmpty()) {
                        throw new InputException("Bitte g�ltigen Interpret eingeben");
                    }
        ...
        loop:
        {
            do {
                try {
                    ...
                    if (titel.isEmpty()) {
                        throw new InputException("Bitte g�ltigen Titel eingeben");
                    }
            ...
            do {
                try {
                    ...
                    if (ort.isEmpty()) {
                        throw new InputException("Bitte g�ltigen Ort eingeben");
                    }
